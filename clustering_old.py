...
plt.scatter(df[1][a == 0], df[2][a == 0], color = "red")
plt.scatter(df[1][a == 1], df[2][a == 1], color = "blue")
plt.scatter(df[1][a == 2], df[2][a == 2], color = "green")
plt.scatter(df[1][a == 3], df[2][a == 3], color = "black")
plt.scatter(df[1][a == 4], df[2][a == 4], color = "yellow")
plt.scatter(df[1][a == 5], df[2][a == 5], color = "magenta")
plt.scatter(df[1][a == 6], df[2][a == 6], color = "brown")
plt.scatter(df[1][a == 7], df[2][a == 7], color = "teal")
plt.scatter(df[1][a == 8], df[2][a == 8], color = "Lime")
